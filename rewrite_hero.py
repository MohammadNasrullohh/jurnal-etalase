...
new_hero = """      {/* 2. Hero Section */}
      <section className="relative w-full overflow-hidden bg-[#F1F6FC] pt-[120px]" style={{ minHeight: '760px' }}>
        {/* Glow */}
        <div className="absolute w-[700px] h-[500px] bg-[#F7921C] blur-[220px] rounded-full opacity-15" style={{ right: '-5%', top: '10%', zIndex: 1, pointerEvents: 'none' }}></div>
        ...
        <div className="container mx-auto px-6 lg:px-20 h-full flex flex-col lg:flex-row items-center justify-between max-w-[1440px] relative z-10" style={{ paddingTop: '80px' }}>
          ...
          <div className="w-full lg:w-[45%] flex flex-col relative z-20">
            <h2 style={{ fontFamily: 'Poppins', fontWeight: 500, fontSize: '24px', color: '#283D52', marginBottom: '8px' }}>Selamat Datang di</h2>
            <div className="flex items-center gap-4 mb-4">
              <img src="/assets/hero-logo-left.png" alt="Logo" className="w-[120px] h-[120px] object-contain" />
              <div className="flex flex-col justify-center">
                <img src="/assets/hero-logo-etalase.png" alt="ETALASE" className="w-[280px] object-contain mb-2" />
                <h1 style={{ fontFamily: 'Poppins', fontWeight: 400, fontSize: '24px', color: '#283D52', lineHeight: '1.2' }}>Arsip Langkah Bawaslu<br/>Kebumen</h1>
              </div>
            </div>
            <p style={{ fontFamily: 'Poppins', fontWeight: 400, fontSize: '16px', color: '#5D6A77', lineHeight: '1.6', maxWidth: '480px', marginBottom: '40px' }}>
          ...
          <div className="w-full lg:w-[50%] flex justify-end relative mt-16 lg:mt-0 z-20 hidden md:flex h-[600px] items-center pr-10">
            <div className="relative w-[520px] h-[520px]">
              {/* Card 4 (Background Green Floating Card) */}
              <div className="absolute left-[-20px] top-[260px] w-[260px] bg-white rounded-2xl p-5 shadow-[0_12px_40px_rgba(20,43,66,0.08)] z-10" style={{ transform: 'rotate(-4deg)' }}>
                <div className="inline-block bg-[#E6F8F3] text-[#10B981] px-4 py-1.5 rounded-lg mb-3" style={{ fontFamily: 'Poppins', fontWeight: 600, fontSize: '11px' }}>20 Sept 2026</div>
                <h3 style={{ fontFamily: 'Poppins', fontWeight: 700, fontSize: '14px', color: '#142B42', marginBottom: '6px' }}>Sosialisasi Pemilu</h3>
                <p style={{ fontFamily: 'Poppins', fontWeight: 400, fontSize: '11px', color: '#7B7A7A' }}>Hotel Kebumen Raya</p>
              </div>

              {/* Card 2 (Main macOS Window) */}
              <div className="absolute right-0 top-[20px] w-[484px] h-[518px] bg-white rounded-[20px] shadow-[0_24px_80px_rgba(20,43,66,0.15)] overflow-hidden border border-[#DED2D2] flex flex-col z-20" style={{ transform: 'rotate(5deg)' }}>
                {/* macOS Header */}
